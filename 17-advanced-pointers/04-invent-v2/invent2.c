...
returns prematurely if the part already exists or space could
...
otherwise, prompts the user to enter change in quantity on
...
showing the part number, part name, and quantity on
hand. Part numbers will appear in ascending order
*/
